package com.kyletung.androiddailyrecord.module.ucrop;
...
import com.kyletung.ucrop.UCrop;
import com.kyletung.ucrop.UCropActivity;
 ...
 */
public class UCropConfigActivity extends BaseActivity {

    private static final String TAG = "UCropConfigActivity";
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE) {
                ...
                if (selectedUri != null) {
                    ...
                    Toast.makeText(UCropConfigActivity.this, R.string.toast_cannot_retrieve_selected_image, Toast.LENGTH_SHORT).show();
                }
    ...
    private void pickFromGallery() {
        if (Build.VERSION.SDK_INT >= 23 // Permission was added in API Level 16
    ...
    private void startCropActivity(@NonNull Uri uri) {
        ...
        uCrop.start(UCropConfigActivity.this);
    }
    ...
    /**
     * Sometimes you want to adjust more options, it's done via {@link com.kyletung.ucrop.UCrop.Options} class.
     *
     * @param uCrop - ucrop builder instance
     * @return - ucrop builder instance
     */
    ...
    private void handleCropResult(@NonNull Intent result) {
        ...
        if (resultUri != null) {
            UCropResultActivity.startWithUri(UCropConfigActivity.this, resultUri);
        } else {
            Toast.makeText(UCropConfigActivity.this, R.string.toast_cannot_retrieve_cropped_image, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void handleCropError(@NonNull Intent result) {
        ...
        if (cropError != null) {
            ...
            Toast.makeText(UCropConfigActivity.this, cropError.getMessage(), Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(UCropConfigActivity.this, R.string.toast_unexpected_error, Toast.LENGTH_SHORT).show();
        }
    }
